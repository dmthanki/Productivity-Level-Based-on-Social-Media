...
# # ========== Step 1: Load ==========
# DATA_PATH = "E:\MCA\Sem 3\Machine Learning\Project\Dataset\social_media_vs_productivity.csv"
...
# # Categorical feature names from OHE
# # ohe = preprocess.named_transformers_['cat']['onehot']
# # try:
# #     cat_feature_names = ohe.get_feature_names_out(preprocess.transformers_[1][2]).tolist()
# # except Exception:
# #     # Older sklearn
# #     cat_feature_names = ohe.get_feature_names(preprocess.transformers_[1][2]).tolist()

# # feature_names = preprocess.transformers_[0][2] + cat_feature_names  # num + cat expanded
